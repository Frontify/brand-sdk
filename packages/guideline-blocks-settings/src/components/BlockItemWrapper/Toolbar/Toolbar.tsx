...
export const Toolbar = ({ items, attachments }: ToolbarProps) => (
    <div
        ...
        className="tw-rounded-md tw-bg-surface tw-border tw-border-line-strong tw-divide-x tw-divide-line-strong tw-shadow-lg tw-flex tw-flex-none tw-items-center tw-isolate"
    >

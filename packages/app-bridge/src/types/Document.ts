...
export type DocumentLink = PickRequired<Document, 'title' | 'linkUrl' | 'linkType' | 'portalId' | 'documentGroupId'> & {
    categoryId?: number;
...
export type DocumentLibrary = PickRequired<
    Document,
    'title' | 'portalId' | 'heading' | 'subheading' | 'documentGroupId'
> & {
    documentGroupId?: number;
